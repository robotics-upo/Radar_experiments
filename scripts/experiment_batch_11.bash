...
until [ $CONTADOR -gt $2 ]; do
  ...
  roslaunch radar_experiments localize_with_gt.launch gt_filename:=stats_dbscan_fusion_11_$CONTADOR.txt localize_method:=fusion bag_name:=$BAG initial_pose_x:=$X initial_pose_y:=$Y initial_pose_a:=$A
