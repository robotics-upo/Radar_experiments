...
until [ "$CONTADOR" -gt "$2" ]; do
  ...
  do
    ...
    roslaunch radar_experiments localize_with_gt.launch gt_filename:=stats_clustered_experiment_${i}_$CONTADOR.txt localize_method:=fusion  bag_name:="published/experiment_${i}.bag" scan_topic:=/dbscan_fuser/segmented_scan points_stats_filename:="points_experiment_${i}.m"
